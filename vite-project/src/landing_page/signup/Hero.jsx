    ...
    return ( 
        <div className="main md:h-[100vh] md:flex md:justify-center p-2 ">
            <div className="container h-full md:w-[80vw] flex flex-col items-center overflow-hidden">
                ...
                <div className=" md: border-none  shadow-lg w-[90%] flex flex-col items-center justify-center mt-4 p-3 md:mt-0 md:p-0 bg-white rounded-lg">
                    ...
                    <div className="form md:w-[50%]">
                        ...
                        <form action="" className="class ">
                            <div className="flex mt-6 mb-8">
                                <div className="flex justify-center items-center border-1 border-r-0 p-3 pl-4 pr-4 border-gray-500">
                                    <img src="media/flag.svg" alt="" />
                                    <p className="l">+91</p>
                                </div>
                                <input type="text" maxlength="10" pattern="[0-9]{10}" inputmode="numeric" placeholder="Enter your mobile number" className="border-1 md:p-3 md:pl-6 md:pr-7 p-2 text-md text-gray-900 w-[60vw] md:w-[18vw] border-gray-500" />

                            </div>
                            <button className="text-lg border-0 md:p-3 p-2 pl-25 pr-26 md:pl-25 md:pr-25 bg-blue-500 text-white font-medium rounded-sm hover:bg-gray-800">Get OTP</button>
                        </form>
                        </div>
