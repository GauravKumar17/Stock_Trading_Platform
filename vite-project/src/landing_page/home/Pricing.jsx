...
function Pricing() {
    return (  
    <div className="container h-[40vh] md:flex ">
        ...
        <div className="right p-2 md:w-[40%]"><img src="media/ftra.png " alt="" className='h-full w-full object-contain hidden md:block'/>
